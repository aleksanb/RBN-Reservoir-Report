...
\begin{figure}
  \subfloat[Input]{
    \resizebox{\columnwidth}{!}{
      \includegraphics{method/temporal_parity-10-200-3-input.pdf}
    }
  }

  \subfloat[Correct output]{
    \resizebox{\columnwidth}{!}{
      \includegraphics{method/temporal_parity-10-200-3-output.pdf}
    }
  }
...
\todo{Here there'll be a somewhat compact explanation of the tasks and required reservoir complexity,
...
\begin{figure}
  ...
  \subfloat[Unperturbed]{
    \resizebox{0.5\columnwidth}{!}{
      \includegraphics{method/final-1-noperturb.pdf}
      \label{figure:rbn-noperturb}
    }
  }
  \subfloat[Perturbed]{
    \resizebox{0.5\columnwidth}{!}{
      \includegraphics{method/final-1-perturb.pdf}
