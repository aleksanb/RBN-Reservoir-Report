...
%    }
%    \subfloat{
%      \input{results/figures/distribution-100-5.tex}
%    }
%    \subfloat{
%      \input{results/figures/distribution-100-5-3.tex}
%    }
  ...
  \begin{tikzpicture}
    \begin{axis}
      [
        ...
        xlabel=Evolved RBN connectivity,
        ytick={1,2,3,4,5},
        yticklabels={
          {L50 \#1},
          {L50 \#2},
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Connectivity for evolved RBNS. Extremely similar to the original connectivity of 50!}
\end{figure}
