...
It was therefore proposed in both \cm{original esn paper} and \cm{original-lsm-paper}
...
In \cm{water-bucket-paper} the authors successfully implement a RC system using a literal reservoir of water as their reservoir.
