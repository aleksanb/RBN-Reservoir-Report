...
\todo[inline]{Do i need a section here presenting traditional RC systems, or is the description in the introduction good enough?}
...
\todo[inline]{Should i have this section here, or should i talk about GA in the Method section instead? How much use really is a huge background chapter on GA/EAs here? Where would i put discussions on choice of genome (that should perhaps go in the discussion section after results or simething?}
